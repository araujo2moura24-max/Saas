...
import { Layers, Mail, Lock, AlertCircle, ChevronRight, Check } from "lucide-react"
...
export default function LoginPage() {
  ...
  async function runConnectionSequence(completed: boolean) {
    setStep("connecting")
    setConnectionLines([])
    
    for (let i = 0; i < CONNECTION_SEQUENCE.length; i++) {
      await new Promise(resolve => setTimeout(resolve, 500))
      setConnectionLines(prev => [...prev, CONNECTION_SEQUENCE[i]])
    }
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (data.user) {
        ...
        await runConnectionSequence(completed)
      } else {
        ...
        <AnimatePresence mode="wait">
          ...
          {step === "form" && (
            ...
            >
              ...
              <div className="bg-[#12121a] rounded-t-xl border border-white/10 border-b-0 p-3 flex items-center gap-2">
                ...
                <span className="text-xs text-white/40 ml-2 font-mono">acessar-ambiente.sh</span>
              </div>
          ...
          {step === "connecting" && (
            ...
            >
              <div className="text-center mb-8">
                ...
                <h2 className="text-xl font-semibold text-white">Conectando ao ambiente...</h2>
              </div>
              ...
              <div className="bg-[#0f0f16] rounded-xl border border-white/10 p-6 font-mono text-sm">
                ...
                {connectionLines.length < CONNECTION_SEQUENCE.length && (
          ...
          {step === "success" && (
            ...
            >
              ...
              <p className="text-white/50">Carregando seu ambiente...</p>
            </motion.div>
          )}
        </AnimatePresence>
      </div>
